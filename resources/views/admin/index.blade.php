...
@foreach($data as $value)
    <div class='box_content px-2 py-4 border-bottom'><h5><a href='/article/read/?id={{$value->id}}'>{{$value->article_title}}</a></h5>
        <div class='pt-3'>
            ...
            <div class='manage_button float-right'>
                <a href="/article/read/?id={{$value->id}}">查看</a> | <a href="" style="color: #e9322d">删除</a>
            </div>
        </div>
    </div>
@endforeach
