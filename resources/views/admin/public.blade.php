...
<div class="content">
    ...
    <div class="container-fluid position-fixed w-100 h-100" style="padding: 0">
        <div class="row w-100 h-100 m-0">
            <nav class="nav flex-column col-md-2 d-none d-md-block pt-4 pr-0" style="background-color: #343a40;">
            ...
            <div class="flex-column col-md-2 d-none d-md-block w-100 h-100 border-left pt-3">
                <div class="user w-100 h-25 mt-5">
                    ...
                    <small><table class="table text-center mt-2">
                        <thead>
                        <tr>
                            <th>文章数</th>
                            <th>阅读数</th>
                ...
                <div class="article_list">
                    <span style="border-left: 10px solid #4141AA;padding-left: 5px"><small>最新文章</small></span>
